...
<h1>피라미터 입력을 활용한 업다운 게임 구현하기</h1>
<hr>
<%@ page import="java.util.Random" %>
<%!
	private Random ran = new Random();		// 매번 새로 생헐할 수 없기 때문에 선언부
	private int count = 0;					// 진행하는 동안 횟수가 유지되어야 하기 때문에
	private int cpu = ran.nextInt(100) + 1;	// 입력마다 값이 바뀌면 안되니까(유지 되어야 함)
											// 선언부에서는 request및 response에 접근 불가
%>
