...
<ul>
	...
	<li>HTTP Method POST의 경우, 문자열 혹은 파일객체로 구성할 수 있다</li>
...
<ul>
	...
	<li>JSP 내용 객체에 저장해둘 수 있고, 내장객체에 따라 유효범위가 다르다</li>
...
<table border="1" sellpadding="10" cellspacing="0">
	<tr>
		<th>내장객체</th>
		<th>유표범위</th>
	</tr>
	...
	<tr>
		...
		<td>
			...
			forward를 이용하면, forward 대상 페이지에서도 attirbute를 참조할 수 있다			
		</td>
	</tr>
	<tr>
		<td>session</td>
