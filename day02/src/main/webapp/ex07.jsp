...
<h3>파라미터를 입력받는 다양한 방법</h3>
<hr>

<fieldset>
	<legend>String requset.getParameter("String name")</legend>
...
<fieldset>
	<legend>Map&lt;String, String[]> requset.getParameterMap()</legend>
	<h4>앞 값의 개수에 상관없이 모든 값을 받아온다</h4>
...
<fieldset>
	...
	<h4>받고 싶은 파라미터를 클래스로 묶어서 만들어주면 자동으로 받는 "태그"가 있다</h4>
	<form>
	...
	<jsp:useBean id="ob" class="food.FoodDTO" /> <%-- 한 객체를 기본생성자로 생성한다 --%>
	<jsp:setProperty property="*" name="ob" /> <%-- <input name과 필드이름을 맞추면 된다 --%>
