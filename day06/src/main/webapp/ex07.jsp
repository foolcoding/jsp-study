...
<ul>
	...
	<li>JSTL Format : 숫자, 날짜 및 시간 등의 서식을 지정하기 위한 테그</li>
...
<ol>
	...
	<li>표현식은 EL Tag를 이용하여 대체할 수 없다</li>
	<li>action태그는 기본 JSP문법을 확장하여 여러 태그를 제공하지만, 부족한점이 있었다</li>
	...
	<li>EL Tag는 JSP의 기본스펙이지만, JSTL은 라이브러리 파일을 /WEBINF/lib폴더에 넣어야 한다</li>
